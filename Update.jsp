...
<title>Insert title here</title>
    <style>
        body {
            background-image: url("http://www.myfreetextures.com/wp-content/uploads/2014/10/sky2.jpg");
...
<body>
	...
	try {
	    ...
	    PreparedStatement ps1 = con.prepareStatement("select * from sunbase where Phone=?");
	    ps1.setString(1, sid);
    ...
    <table>
        ...
        <tr><td>City</td><td><input type="text" name="Street" value="<% out.print(ar.get(2)); %>"style="border-radius:30px"/></td></tr>
